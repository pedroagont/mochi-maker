...
function st3() {
  face_shape.style.fill='mediumaquamarine';
   ear_light.style.fill='mediumaquamarine';
   ear_mid.style.fill='#d49f83';
   ear_dark.style.fill='#b37d6065';
}
...
function st4() {
  face_shape.style.fill='lightgreen';
   ear_light.style.fill='lightgreen';
   ear_mid.style.fill='#d49f83';
   ear_dark.style.fill='#b37d6065';
}
...
function st5() {
  face_shape.style.fill='orange';
   ear_light.style.fill='orange';
   ear_mid.style.fill='#d49f83';
   ear_dark.style.fill='#b37d6065';
}
...
function st6() {
  face_shape.style.fill='slateblue';
   ear_light.style.fill='slateblue';
   ear_mid.style.fill='#d49f83';
   ear_dark.style.fill='#b37d6065';
}
...
eb_3.addEventListener("click", showEyebrow3);
  ...
  //----------------- background image cannot download-----------------
/*
const a = document.getElementById("avatar");

document.getElementById("bg_1").addEventListener("click", function(){
  a.style = "background-image: url('images/background/background1.png');";
});

document.getElementById("bg_2").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background2.png');";
});

document.getElementById("bg_3").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background3.png');";
}); 

document.getElementById("bg_4").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background4.png');";
});  

document.getElementById("bg_5").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background5.png');";
}); 

document.getElementById("bg_6").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background6.png');";
}); 

document.getElementById("bg_7").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background7.png');";
}); 
  
document.getElementById("bg_8").addEventListener("click", function() {
  a.style = "background-image: url('images/background/background8.png');";
}); 
*/
...
const menu9 = document.querySelector("#menu_bg");
...
menu1.addEventListener("click", function() {
  ...
  document.querySelector(".options_background").style = "display: none;";
});
...
menu9.addEventListener("click", function() {
  ...
  document.querySelector(".options_beards").style = "display: none;";
  document.querySelector(".options_accessories").style = "display: none;";
  document.querySelector(".options_background").style = "display: flex;";
});
*/
